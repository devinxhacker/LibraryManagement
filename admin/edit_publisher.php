...
// Check if publisher ID is provided
if (!isset($_GET['id'])) {
    $_SESSION['error_message'] = "No publisher selected.";
...
if (!$publisher) {
    $_SESSION['error_message'] = "Publisher not found.";
    header("Location: manage_publishers.php");
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        if (update_publisher($publisher_id, $publisher_name, $year_of_pub)) {
            $_SESSION['success_message'] = "Publisher updated successfully.";
            header("Location: manage_publishers.php");
            exit();
        } else {
            $errors[] = "Error updating publisher.";
        }
    }
}
?>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0"><i class="fas fa-building"></i> Edit Publisher</h4>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($errors)): ?>
                        ...
                        <form method="POST" action="">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="publisher_name" name="publisher_name" 
                                       value="<?php echo htmlspecialchars($publisher['publisherName']); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="year_of_pub" name="year_of_pub" 
                                       value="<?php echo htmlspecialchars($publisher['year_of_pub']); ?>" 
