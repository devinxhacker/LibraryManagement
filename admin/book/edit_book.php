...
// Get categories, authors, and publishers for dropdowns
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    if (empty($isbn) || empty($title) || empty($author_id) || empty($publisher_id) || 
        ...
        // Update book
        if (update_book($book_id, $isbn, $author_id, $publisher_id, $title, $edition, $category_id, $price)) {
                        ...
                        <form method="POST" action="">
                                ...
                                <select class="form-select" id="publisher_id" name="publisher_id" required>
                                    ...
                                    <?php while($publisher = mysqli_fetch_assoc($publishers)): ?>
                                        <option value="<?php echo $publisher['publisherID']; ?>"
                                                <?php echo ($publisher['publisherID'] == $book['publisherID']) ? 'selected' : ''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="edition" name="edition" 
                                       value="<?php echo htmlspecialchars($book['edition']); ?>" required>
                            </div>
